 ...
 * Last Updated: $Date: 2010-06-23 10:22:08 -0400 (Wed, 23 Jun 2010) $
 * </pre>
 *
 * @author 		$Author: matt $
...
abstract class dbMain
{
	...
	public function throwFatalError( $the_error='' )
	{
		...
		{
			if ( stristr( $this->error, 'has gone away') OR stristr( $this->error, 'connect to locat mysql server through socket') )
			{
     	...
     	else if ( $this->obj['use_error_log'] AND $this->obj['error_log'] )
		{
			...
			{
				require_once( DOC_IPS_ROOT_PATH . 'cache/skin_cache/'. $errTemplate . '.php' );
