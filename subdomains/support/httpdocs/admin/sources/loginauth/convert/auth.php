 ...
 * Last Updated: $Date: 2010-06-21 10:13:28 -0400 (Mon, 21 Jun 2010) $
 * </pre>
 *
...
class login_convert extends login_core implements interface_login
{
	 ...
	 * @return	boolean		Successful
	 */
	private function _authenticatePhpbb( $username, $password )
	{
		$success			= false;
	...
	private function _authenticateVb3( $username, $password )
	{
		...
		{
			$single_md5_pass	= md5( $password );
			$decr 				= md5( str_replace( '&#33;', '!', $password ) . $this->_memberData['misc'] );
