 ...
 * IP.Board v3.1.2
 * Topic View
 * Last Updated: $Date: 2010-07-14 17:57:17 -0400 (Wed, 14 Jul 2010) $
 * </pre>
 *
...
class public_forums_forums_topics extends ipsCommand
{
	...
	public function doExecute( ipsRegistry $registry )
	{
		...
		/* Data Hook Location */
		IPSLib::doDataHooks( &$this->topic, 'topicViewForumData' );
		...
		$this->registry->output->addMetaTag( 'description', str_replace( "\n", " ", str_replace( "\r", "", strip_tags( $this->_firstPostContent ) ) ), FALSE, 155 );
	...
	*/
	...
	public function _getTopicDataLinear()
	{
		...
		while ( $row = $this->DB->fetch( $oq ) )
		{
			...
			{
				if( $this->settings['ad_code_topic_view_code'] )
				{
					$post_data[ $row['pid'] ]['post']['_adCode']	= $this->settings['ad_code_topic_view_code'];
					$adCodeSet										= true;
				}
			}
