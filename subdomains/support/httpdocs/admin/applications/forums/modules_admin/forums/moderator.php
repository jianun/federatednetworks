 ...
 * Last Updated: $Date: 2010-02-02 05:15:47 -0500 (Tue, 02 Feb 2010) $
 * </pre>
 *
 * @author 		$Author: matt $
...
class admin_forums_forums_moderator extends ipsCommand
{
	...
	*/
	public function modForm( $type='add' )
	{
		...
		$mod['bw_mod_soft_delete_topic']		= $this->registry->output->formYesNo( "bw_mod_soft_delete_topic", $mod['bw_mod_soft_delete_topic'] );
		$mod['bw_mod_un_soft_delete_topic']		= $this->registry->output->formYesNo( "bw_mod_un_soft_delete_topic", $mod['bw_mod_un_soft_delete_topic'] );
		$mod['bw_mod_soft_delete_topic_see']	= $this->registry->output->formYesNo( "bw_mod_soft_delete_topic_see", $mod['bw_mod_soft_delete_topic_see'] );
		$mod['bw_mod_soft_delete_reason']		= $this->registry->output->formYesNo( "bw_mod_soft_delete_reason", $mod['bw_mod_soft_delete_reason'] );
		$mod['bw_mod_soft_delete_see_post']		= $this->registry->output->formYesNo( "bw_mod_soft_delete_see_post", $mod['bw_mod_soft_delete_see_post'] );
