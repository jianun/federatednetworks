 ...
 * IP.Board v3.1.2
 * Forum management
 * Last Updated: $Date: 2010-06-15 21:25:19 -0400 (Tue, 15 Jun 2010) $
 * </pre>
 *
...
class admin_forums_forums_forums extends ipsCommand
{
	...
	public function doRules()
	{
		...
		$rules = array( 
						...
						'rules_raw_html'	=> $this->request['rules_raw_html'],
					  );
	...
	public function forumForm( $type='edit', $changetype=0 )
	{
		...
		foreach( ipsRegistry::$applications as $app_dir => $app_data )
		{
			...
			{
				require_once( IPSLib::getAppDir( $app_dir ) . '/extensions/admin/forum_form.php' );
				$_class  = 'admin_forum_form__' . $app_dir;
