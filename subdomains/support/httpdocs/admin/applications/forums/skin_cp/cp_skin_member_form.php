 ...
 * Last Updated: $LastChangedDate: 2010-02-15 17:36:43 -0500 (Mon, 15 Feb 2010) $
 * </pre>
 *
 * @author 		$Author: josh $
...
$IPBHTML .= <<<EOF
	...
	<div class='tablerow1' id='tabpane-MEMBERS|{$tabID}'>
...
$IPBHTML .= <<<EOF
	<li id='tabtab-MEMBERS|{$tabID}' class=''>{$this->lang->words['m_details']}</li>
EOF;
