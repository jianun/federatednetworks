 ...
 * IP.Board v3.1.2
 * Comments library
 * Last Updated: $Date: 2010-07-19 15:50:14 -0400 (Mon, 19 Jul 2010) $
 * </pre>
 *
...
class messengerFunctions
{
	...
	public function getPersonalTopicsList( $memberID, $folderID, $searchAndSort )
	{
		...
		else
		{
			...
			foreach( $messages as $id => $row )
			{
				...
				$messages[ $id ]['_toMemberData']['_canBeBlocked'] = IPSMember::isIgnorable( $_member['member_group_id'], $_member['mgroup_others'], 'pm' );
	...
	public function fetchConversation( $topicID, $readingMemberID, $filters=array() )
	{
		...
		{
			$memberData[0] = IPSMember::buildDisplayData(IPSMember::setUpGuest( $this->lang->words['deleted_member'] ), array( '__all__' => 1 ) );
		}
