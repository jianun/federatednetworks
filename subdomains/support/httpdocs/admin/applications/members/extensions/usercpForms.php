...
class usercpForms_members extends public_core_usercp_manualResolver implements interface_usercp
{
	...
	public function formFacebook( $inlineMsg='' )
	{
		...
		$_updates = $facebook->fetchUserTimeline( $user['id'], 0, true );
		...
		return $this->registry->getClass('output')->getTemplate('ucp')->membersFacebookConnect( $fbid, $userData, $linkedMemberData, $perms );
	}
