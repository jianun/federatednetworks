...
class search_form_members
{
	...
	{
		$array = array( 'comments' => array( 'date'  => $this->lang->words['s_search_sort_creation_date'] ),
					    'members'  => array( 'date'  => $this->lang->words['s_search_type_0'],
	...
	{
		$array = array( 0 => array( 'comments', $this->lang->words['s_msin_comments'] ),
					    1 => array( 'members', $this->lang->words['s_msin_members'] ) );
