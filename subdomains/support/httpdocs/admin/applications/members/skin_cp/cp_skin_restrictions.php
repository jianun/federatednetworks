...
<tr>
	...
	<td>{$data['_date']}</td>
	<td>
		<img class='ipbmenu' id="menumember{$data['member_id']}" src='{$this->settings['skin_acp_url']}/_newimages/menu_open.png' alt='{$this->lang->words['r_options']}' />
...
<tr>
 ...
 <td class='tablerow1'>
 	<img id="menugroup{$data['row_id']}" src='{$this->settings['skin_acp_url']}/_newimages/menu_open.png' alt='{$this->lang->words['r_options']}' class='ipbmenu' />
