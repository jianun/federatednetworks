...
/**
 * Show notice if no banned_group set
 *
 * @access	public
 * @return	string		HTML
 */
public function bannedGroupNotice(){
$IPBHTML = "";

$IPBHTML .= <<<HTML
<div class='information-box'>
{$this->lang->words['nobannedgroup_notice']}
</div>
<br />
HTML;
...
$IPBHTML .= <<<HTML
<tr>
  <td class='tablerow2' colspan='8'><strong>{$lang}</strong></td>
</tr>
HTML;
...
$image        = $r['spam_flag'] ? array( 'normal_spam.png', $this->lang->words['alt_spamuser'] ) : 
				( ( $r['user_verified'] ) ? array( 'normal_tick.png', $this->lang->words['alt_normal'] ) : 
				array( 'normal_lock.png', $this->lang->words['alt_unverifieduser'] ) );
$color		  = ( $r['user_verified'] ) ? 'red' : 'green';

$IPBHTML .= <<<HTML
<tr>
  <td><img src='{$this->settings['skin_acp_url']}/_newimages/members/{$image[0]}' alt='{$image[1]}' title='{$image[1]}' /></td>
  ...
  <td class='tablerow1'><span style='color:{$color}'>{$r['_where']}</span><br />{$r['_entry']}<div class='desctext'>{$daysandhours}</div></td>
...
$IPBHTML .= <<<HTML
<tr>
  <td><img src='{$this->settings['skin_acp_url']}/_newimages/members/normal_lock.png' alt='*' /></td>
...
$IPBHTML .= <<<HTML
<tr>
  <td><img src='{$this->settings['skin_acp_url']}/_newimages/members/normal_alert.png' alt='*' /></td>
...
$IPBHTML .= <<<HTML
<tr>
  <td><img src='{$this->settings['skin_acp_url']}/_newimages/members/normal_spam.png' alt='*' /></td>
  <td class='tablerow2'><a href='{$this->settings['base_url']}&amp;module=members&amp;section=members&amp;do=viewmember&amp;member_id={$r['member_id']}'><strong>{$r['members_display_name']}</strong></a></td>
  <td class='tablerow1'>{$r['email']}</td>
  <td class='tablerow1' align='center'>{$r['posts']}</td>
  <td class='tablerow1'>{$r['group_title']}</td>
 ...
 * @return	string		HTML
 */
public function incompleteRow( $r="" ) {
$IPBHTML = "";
//--starthtml--//

$publicUrl = $this->settings['_original_base_url'] . '/' . PUBLIC_DIRECTORY . '/';

$r['email']                = ( $r['_emailIsOk'] ) ? $r['email'] : '<em>' . $this->lang->words['inc_no_email'] . '</em>';
$r['members_display_name'] = ( $r['_dnameIsOk'] ) ? $r['members_display_name'] : '<em>' . $this->lang->words['inc_no_dname'] . '</em>';
$r['serviceImg']           = "<img src='{$this->settings['skin_acp_url']}/_newimages/members/internet.png' />";

if ( $r['_regVia'] == 'facebook' )
{
	$r['serviceImg'] = "<a href='http://www.facebook.com/profile.php?id={$r['fb_uid']}' target='_blank'><img src='{$this->settings['skin_acp_url']}/_newimages/members/facebook.png' /></a>";
}

if ( $r['_regVia'] == 'twitter' )
{
	$r['serviceImg'] = "<img src='{$this->settings['skin_acp_url']}/_newimages/members/twitter.png' />";
}

$IPBHTML .= <<<HTML
<tr>
  <td><a href='{$this->settings['base_url']}&amp;module=members&amp;section=members&amp;do=viewmember&amp;member_id={$r['member_id']}'><img src='{$r['pp_thumb_photo']}' style='width: 30px; height: 30px; border: 1px solid #d8d8d8' /></a></td>
  <td class='tablerow2'>
  	<a href='{$this->settings['base_url']}&amp;module=members&amp;section=members&amp;do=viewmember&amp;member_id={$r['member_id']}'><strong>{$r['members_display_name']}</strong></a>
  	<div class='desctext' style='margin-top:4px'>{$this->lang->words['inc_m_name']}: {$r['name']}</div>
  </td>
  <td class='tablerow1'>{$r['serviceImg']}</td>
  <td class='tablerow1'>{$r['email']}</td>
  <td class='tablerow1'>{$r['group_title']}</td>
  <td class='tablerow1'>{$r['_joined']}</td>																
  <td class='tablerow1' align='center'><input type='checkbox' id="mid_{$r['member_id']}" name='mid_{$r['member_id']}' value='1' /></td>
