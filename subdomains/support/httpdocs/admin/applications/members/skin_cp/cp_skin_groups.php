...
$g_view_board_warning_style = $group['g_view_board'] ? 'display:none' : '';
$g_view_board_warning_message = sprintf( $this->lang->words['gf_view_board_warning'], $this->buildURL( 'app=core&module=tools&section=settings', 'admin' ) );
...
$semaillimit = sprintf( $this->lang->words['gf_semail_limit'], $form['join_limit'] );
$semailflood = sprintf( $this->lang->words['gf_semail_flood'], $form['join_flood'] );
...
$_firstTab = ( $firsttab ) ? '\'GROUPS|' . $firsttab . "'" : "''";
...
{
	ipbAcpTabStrips.first_on_load = $_firstTab;
...
<div class='acp-box'>
	<div id='tabpane-GROUPS|1'>
		<table width='100%' cellpadding='0' cellspacing='0' class='form_table alternate_rows double_pad'>
			...
			<tr>
				<td style='width: 40%'>
					<label>{$this->lang->words['gf_gtitle']}</label>
				</td>
				<td style='width: 60%'>
					{$form['g_title']}
				</td>
			...
			<tr>
		 		<td>
					<label>{$this->lang->words['gf_gicon']}</label><br />
		 	...
		 	<tr>
		 		<td>
					<label>{$this->lang->words['gf_gformpre']}</label><br />
		 	...
		 	<tr>
		 		<td>
					<label>{$this->lang->words['gf_gformsuf']}</label><br />
			...
			<tr>
		 		<td>
					<label>{$this->lang->words['gf_permset']}</label><br />
		 	...
		 	<tr class='guest_legend'>
		 		<td>
		 			<label>{$this->lang->words['gf_hide']}</label>
		 			{$guest_legend}
		 		</td>
		 		<td>
		 	...
		 	<tr class='guest_legend'>
		 		<td>
		 			<label>{$this->lang->words['gf_hide_online']}</label>
		 			{$guest_legend}
		 		</td>
		 		<td>
			...
			<tr>
		 		<td>
					<label>{$this->lang->words['gf_dmax']}</label><br />
					<span class='desctext'>{$this->lang->words['gf_dmax_info']}</span>
				</td>
		 		<td>
		 	...
		 	<tr>
		 		<td>
					<label>{$this->lang->words['gf_dlimit']}</label><br />
					<span class='desctext'>{$this->lang->words['gf_dlimit_info']}</span>
				</td>
		 		<td>
		 			{$form['g_dname_date']}
		 		</td>
		 	...
		 	<tr class='guest_legend'>
		 		<td>
		 			<label>{$this->lang->words['gf_msup']}</label>
		 			{$guest_legend}
		 		</td>
		 		<td>
		 			{$form['g_is_supmod']}
		 	...
		 	<tr class='guest_legend'>
		 		<td>
		 			<label>{$this->lang->words['gf_macp']}</label>
		 			{$guest_legend}
		 		</td>
		 		<td>
		 			{$form['g_access_cp']}
		 	...
		 	<tr class='guest_legend'>
		 		<td>
					<label>{$this->lang->words['gf_mpromote']}</label><br />
					{$guest_legend}
 ...
 <div id='tabpane-GROUPS|2'>
	 <table class='form_table alternate_rows double_pad' cellspacing='0'>
		<tr>
	 	...
	 	<tr>
	 		<td style='width: 40%'>
				<label>{$this->lang->words['gf_ssite']}</label>
			</td>
	 		<td style='width: 60%'>
	 			{$form['g_view_board']}
	 			<div id='g_view_board_warning' style='{$g_view_board_warning_style}'>
	 				<br /><br /><div class='information-box'>{$g_view_board_warning_message}</div>
	 			</div>
	 		</td>
	 	</tr>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_soffline']}</label>
			</td>
	 		<td>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_sprofile']}</label>
			</td>
	 		<td>
	 			{$form['g_mem_info']}
	 		</td>
	 	...
	 	<tr class='guest_legend'>
	 		<td>
				<label>{$this->lang->words['gf_addfriends']}{$guest_legend}</label>
			</td>
	 		<td>
	 	...
	 	<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_editprofile']}</label>
	 			{$guest_legend}
	 		</td>
	 		<td>
	 			{$form['g_edit_profile']}
	 	...
	 	<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_shtml']}</label><br />
	 			{$guest_legend}
		...
		<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_semail']}</label><br />
	 			{$guest_legend}
		...
		<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_maxnotify']}</label><br />
	 			{$guest_legend}
				<span class='desctext'>{$this->lang->words['gf_maxnotify_desc']}</span>
	 		</td>
	 		<td>
	 			{$form['g_max_notifications']}
	 		</td>
	 	</tr>
		<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_uav']}</label>
	 			{$guest_legend}
	 		</td>
	 		<td>
		...
		<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_sbadword']}</label>
	 			{$guest_legend}
	 		</td>
	 		<td>
		...
		<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_no_status']}</label>
	 			{$guest_legend}
	 		</td>
	 		<td>
	 	...
	 	<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_no_status_import']}</label>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_bw_allow_customization']}</label>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_bw_allow_url_bgimage']}</label>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_bw_allow_upload_bgimage']}</label>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_ssearch']}</label>
			</td>
	 		<td>
	 			{$form['g_use_search']}
	 		</td>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_sflood']}</label><br />
	 	...
	 	<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_spm']}</label><br />
	 			{$guest_legend}
	 	...
	 	<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_spmmax']}</label><br />
	 			{$guest_legend}
	 	...
	 	<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_spmmaxstor']}</label>
	 			{$guest_legend}
	 		</td>
	 		<td>
	 			{$form['g_max_messages']}
		...
		<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_upm']}</label>
	 			{$guest_legend}
	 		</td>
	 		<td>
		...
		<tr>
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_repmaxpos']}</label><br />
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_repmaxneg']}</label><br />
				<span class='desctext'>{$this->lang->words['gf_repnum_info']}</span>
	 		</td>
	 		<td>
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_bw_view_reps']}</label><br />
	 		</td>
	 		<td>
	 			{$form['gbw_view_reps']}
	 		</td>
		...
		<tr>
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_usesigs']}</label>
	 		</td>
	 		<td>
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_sigmaximages']}</label>
	 		</td>
	 		<td>
	 			{$form['max_images']}
	 		</td>
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_sigmaxdims']}</label>
	 		</td>
	 		<td>
	 			{$form['max_dims']}
	 		</td>
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_sigmaxurls']}</label>
	 		</td>
	 		<td>
	 			{$form['max_urls']}
	 		</td>
	 	...
	 	<tr>
	 		<td>
	 			<label>{$this->lang->words['gf_sigmaxtext']}</label>
	 		</td>
	 		<td>
	 			{$form['max_lines']}
	 		</td>
		...
		<tr>
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_uglobal']}</label><br />
				<span class='desctext'>{$this->registry->output->javascriptHelpLink('mg_upload')}<br />{$this->lang->words['gf_uglobal_info']}</span>
			</td>
	 		<td>
	 			{$form['g_attach_max']}
	 	...
	 	<tr>
	 		<td>
				<label>{$this->lang->words['gf_upost']}</label><br />
				<span class='desctext'>{$this->registry->output->javascriptHelpLink('mg_upload')}<br />{$this->lang->words['gf_upost_info']}</span>
			</td>
	 		<td>
	 	...
	 	<tr class='guest_legend'>
	 		<td>
	 			<label>{$this->lang->words['gf_upersonalpho']}</label><br />
	 			{$guest_legend}
...
$leSigh = ( $this->request['showSecondary'] ) ? ' class="closed"' : '';
...
<div class='section_title'>
	<ul class='context_menu'>
		<li{$leSigh}>
			<a href='{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=groups_overview&amp;showSecondary={$leBigh}'><img src='{$this->settings['skin_acp_url']}/_newimages/icons/cog.png' /> {$this->lang->words['g_calc_with_secondary']}</a>
		</li>
	</ul>
</div>
...
$IPBHTML .= <<<HTML
<tr>
  <td><img src='{$this->settings['skin_acp_url']}/_newimages/icons/group.png' /></td>
  ...
  <td align='center'><img src='{$this->settings['skin_acp_url']}/_newimages/icons/{$r['_can_acp_img']}' alt='-' /></td>
  <td align='center'><img src='{$this->settings['skin_acp_url']}/_newimages/icons/{$r['_can_supmod_img']}' alt='-' /></td>
  <td align='center'>
HTML;
...
$IPBHTML .= <<<HTML
	<a href='{$this->settings['_base_url']}app=members&amp;section=members&amp;module=members&amp;__update=1&amp;f_primary_group={$r['g_id']}{$_extraLink}' title='{$this->lang->words['g_listusers']}'>{$r['count']}</a>
HTML;
}
else
{
...
$IPBHTML .= <<<HTML
  ...
  <td align='right'>
  	<img id="menu{$r['g_id']}" src='{$this->settings['skin_acp_url']}/_newimages/menu_open.png' alt='{$this->lang->words['a_options']}' class='ipbmenu' />
