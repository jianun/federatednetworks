 ...
 * Last Updated: $Date: 2010-06-18 18:36:01 -0400 (Fri, 18 Jun 2010) $
 * </pre>
 *
...
<div class='information-box'>
	<h4><img src='{$this->settings['skin_acp_url']}/_newimages/icons/bullet_error.png' />{$this->lang->words['bulkmail_notes_tl']}</h4> 
...
<tr>
  ...
  <td>{$time_taken}</td>
  <td>
  	<img id='mid-{$r['mail_id']}' src='{$this->settings['skin_acp_url']}/_newimages/menu_open.png' alt='{$this->lang->words['b_options']}' class='ipbmenu' />
