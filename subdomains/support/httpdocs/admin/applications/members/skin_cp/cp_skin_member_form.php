 ...
 * Last Updated: $Date: 2010-06-09 20:15:29 -0400 (Wed, 09 Jun 2010) $
 * </pre>
 *
...
<form action='{$this->settings['base_url']}&amp;module=members&amp;section=members&amp;do=ban_member&amp;member_id={$member['member_id']}' method='post'>
	<div class='acp-box'>
		...
		<ul class='acp-form modal-overflow'>
			<li>
				{$form['member']}
...
EOF;
			...
			{
				$IPBHTML .= "<li><label class='head'>{$this->lang->words['ipaddresses']}</label></li>";
...
<script type='text/javascript'>
	...
	acp.members.fields['MF__password']['bypass'] = true;
</script>

<form action='{$this->settings['base_url']}&amp;module=ajax&amp;section=editform&amp;do=save_password&amp;member_id={$member['member_id']}&amp;secure_key={$this->member->form_hash}' method='post'>
<div class='acp-box'>
