...
function stripGuestLegend()
{
	...
	$('g_view_board_no').observe('click', function(e){
		$('g_view_board_warning').style.display = 'inline';
	});
	$('g_view_board_yes').observe('click', function(e){
		$('g_view_board_warning').style.display = 'none';
	});
}