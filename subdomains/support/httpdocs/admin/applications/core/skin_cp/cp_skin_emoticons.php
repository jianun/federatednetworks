...
$IPBHTML .= <<<HTML
				<td width='{$td_width}%' align='center'>
					<fieldset>
						...
						<img src='../public/style_emoticons/{$this->request['id']}/{$r['image']}' />&nbsp;&nbsp;&nbsp;&nbsp;
HTML;
...
$IPBHTML .= <<<HTML
						<a href='{$this->settings['base_url']}{$this->form_code}do=emo_remove&eid={$r['id']}&id={$this->request['id']}' title='{$this->lang->words['emote_delete_title']}'>
							<img src='{$this->settings['skin_acp_url']}/images/emo_delete.gif' alt='{$this->lang->words['emote_delete_title']}' />						
						</a>
						<br />
...
$IPBHTML .= <<<HTML
			<tr>
	 			<td valign='middle'>
					...
					{$data['line_image']}<img src='{$this->settings['skin_acp_url']}/images/emoticon_folder.gif' />&nbsp;
