 ...
 * Last Updated: $Date: 2010-04-20 17:59:59 -0400 (Tue, 20 Apr 2010) $
 * </pre>
 *
...
<div class='acp-box'>
	...
	<ul class='acp-form'>
		<li>
			{$this->lang->words['selectoneomorecss']}
		</li>
...
<div class='acp-box'>
	...
	<ul class='acp-form'>
		<li>
			{$this->lang->words['exportonesettings']}
		</li>
		<li style='padding-left: 15px'>
			{$form['groups']}
		</li>
		<li>
			{$this->lang->words['indivsettingsex']}
		</li>
		<li style='padding-left: 15px'>
			{$form['settings']}
		</li>
...
<div class='acp-box'>
	...
	<ul class='acp-form'>
		<li>
			{$this->lang->words['pathcustomscript']}
		</li>
		<li style='padding-left: 15px'>
...
<div class='acp-box'>
	...
	<ul class='acp-form'>
		<li>
			{$this->lang->words['selectoneormorehelp']}
		</li>
		<li style='padding-left: 15px'>
			{$form['help']}
		</li>
...
EOF;
	...
	<div class='acp-actionbar'>
		<input type='submit' value='{$this->lang->words['addanotherfile']}' class='realbut}ton' id='addLanguage' /> <input type='submit' value=' {$this->lang->words['hookssavebutton']} ' class='realbutton' id='MF__language_save' />
		<script type='text/javascript'>
...
<script type='text/javascript'>
	...
	ipb.templates['skin_row'] = new Template("<li><table width='100%' cellpadding='0' cellspacing='0'><tr><td style='width: 35%; vertical-align: top;'>#{control}<br /><span class='desctext skindesc' id='s_container_desc_#{containerid}' style='display: none'>{$this->lang->words['nowselectbits']} {$this->lang->words['_rarr']}</span></td><td style='vertical-align: top;'><div id='s_container_#{containerid}' style='display: none'></div></td></tr></table></li>");
