 ...
 * Last Updated: $LastChangedDate: 2010-02-16 11:51:14 -0500 (Tue, 16 Feb 2010) $
 * </pre>
 *
...
class reportLibrary
{
	...
	public function loadPlugin( $plugin_name, $app )
	{
		...
		{
			if( file_exists( IPSLib::getAppDir( $app ) . '/extensions/reportPlugins/' . $plugin_name . '.php' ) )
			{
				require_once( IPSLib::getAppDir( $app ) . '/extensions/reportPlugins/' . $plugin_name . '.php' );
