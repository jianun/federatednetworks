...
class admin_core_tools_sharelinks extends ipsCommand
{
	...
	*/	
	 ...
	 * @return	void
	 */
	private function shareLinksReorder()
	{
		/* AJAX Class */
	...
	public function sharelinksForm( $type='add' )
	{
		...
		if( $type == 'add' )
		{
			...
			$data   = array(
								'share_title'		=> $this->request['share_title'],
								'share_url'			=> $this->request['share_url'],
								'share_key'			=> $this->request['share_key'],
								'share_enabled'		=> $this->request['share_enabled'],
								'share_canonical'	=> $this->request['share_canonical']
							);
		...
		else
		{
			...
			/* Set Defaults */
			$data['share_title']		= ( isset( $this->request['share_title'] ) 		&& $this->request['share_title'] )		? $this->request['share_title']		: $data['share_title'];
			$data['share_key']			= ( isset( $this->request['share_key'] )		&& $this->request['share_key'] )		? $this->request['share_key']		: $data['share_key'];
			$data['share_enabled']		= ( isset( $this->request['share_enabled'] )	&& $this->request['share_enabled'] )	? $this->request['share_enabled']	: $data['share_enabled'];
			$data['share_canonical']	= ( isset( $this->request['share_canonical'] )	&& $this->request['share_canonical'] )	? $this->request['share_canonical']	: $data['share_canonical'];
		}
	 ...
	 * @return void
	 **/
	private function _sharelinksIndex()
	{
		/* Init */
		$rows = array();
