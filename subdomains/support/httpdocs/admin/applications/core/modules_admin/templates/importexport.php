...
class admin_core_templates_importexport extends ipsCommand
{
	...
	private function _importImages()
	{
		...
		if( ! $importName )
		{
			$importName = isset( $_FILES['FILE_UPLOAD']['name'] ) && $_FILES['FILE_UPLOAD']['name'] ? $_FILES['FILE_UPLOAD']['name'] : $this->request['importLocation'];
		}
	...
	private function _showForm()
	{
		...
		$form['exportImgDirs']    = $this->registry->output->formDropdown( 'exportImgDirs', $_imageDirs, $_POST['exportImgDirs'] );
