 ...
 * Last Updated: $LastChangedDate: 2010-01-20 17:13:56 -0500 (Wed, 20 Jan 2010) $
 * </pre>
 *
 * @author 		$Author: josh $
...
{	
	...
	{
		return "SELECT com_id, my_class, extra_data, app FROM " . $this->db->obj['sql_tbl_prefix'] . "rc_classes WHERE onoff=1 AND " . $data['COL'] . " REGEXP '.*,(" . implode( '|' , $data['GROUP_IDS'] ) . "),.*'";
	}
}