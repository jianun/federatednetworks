 ...
 * Last Updated: $Date: 2010-07-13 07:34:38 -0400 (Tue, 13 Jul 2010) $
 * </pre>
 *
 * @author 		$Author: matt $
...
class public_core_global_login extends ipsCommand
{
	...
	public function doExecute( ipsRegistry $registry ) 
	{
    	...
    	switch( $this->request['do'] )
    	{
    		case 'process':
				...
				{
    				$this->registry->getClass('output')->redirectScreen( $return[0], $return[1], 'false' );
				}
    		break;
    		...
    		case 'logout':
				...
				{
					$this->registry->getClass('output')->redirectScreen( $return[1], $return[2], 'false' );
				}
    		break;
    ...
    public function loginForm( $message="", $replacement='' )
    {
		...
		if ( $serviceClick )
		{
			...
			{
				case 'facebook':
					$this->registry->getClass('output')->silentRedirect( $this->settings['_original_base_url'] . "/interface/facebook/index.php?reg=1" );
				break;
				case 'twitter':
					$this->registry->getClass('output')->silentRedirect( $this->settings['_original_base_url'] . "/interface/twitter/index.php?reg=1" );
				break;
			}
		}
