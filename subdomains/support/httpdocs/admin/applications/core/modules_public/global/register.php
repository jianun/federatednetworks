 ...
 * Register
 * Last Updated: $Date: 2010-07-14 00:56:23 +0100 (Wed, 14 Jul 2010) $
 * </pre>
 *
 * @author 		$Author $
...
class public_core_global_register extends ipsCommand
{
	...
	private function _completeRegistrationSave()
	{
		...
		if ( $connectService AND $login_user AND $login_pass AND ! $members_display_name )
		{
			/* Load Full Member */
		...
		$member_group_id      = ( $tmp_member['twitter_token'] AND $tmp['member_group_id'] == $this->settings['auth_group']) ? $this->settings['member_group'] : $tmp_member['member_group_id'];
