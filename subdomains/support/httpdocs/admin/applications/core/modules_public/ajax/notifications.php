...
class public_core_ajax_notifications extends ipsAjaxCommand 
{
	...
	protected function getMyNotifications()
	{
		...
		$_data = $notifyLibrary->fetchUnreadNotifications( 10, 'notify_sent', 'DESC', false );
    	...
    	$this->returnJsonArray( array( 'html' => $this->registry->output->getTemplate('global_other')->notificationsList( $_data ) ) );
	}
}