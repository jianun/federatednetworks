 ...
 * IP.Board v3.1.2
 * Setup skin file
 * Last Updated: $Date: 2010-07-20 07:40:12 -0400 (Tue, 20 Jul 2010) $
 * </pre>
 *
 * @author 		$Author: matt $
...
EOF;
	...
	else
	{
		...
		<span style='color:red; font-weight: bold;'>Your memory limit: {$_memLimit}.<br />Please contact your host and request the memory limit be raised to {$_recLimit}M.</span>
EOF;
	}
}
else
...
$IPBHTML .= <<<EOF
	...
	<fieldset>
     <legend>License Key</legend>
		<table style='width: 100%; border: 0px; padding:0px' cellspacing='0'>
	      ...
	      <tr>
	          <td colspan='2'><span style='color: gray'>Enterring your license key <span style='font-weight:bold'>is optional</span> but doing so entitles you to <a href='http://external.ipslink.com/ipboard30/landing/?p=license'>additional features and benefits</a>.</span></td>
	      </tr>
	  	</table>
	 </fieldset>
	 <br />
	...
	<div class='message unspecific note'>
		<a href='http://external.ipslink.com/ipboard30/landing/?p=lkey'>How to locate your license key</a>
	</div>
...
{
	$IPBHTML .= <<<EOF
					<p><a href='http://external.ipslink.com/ipboard30/landing/?p=installation-guide' target='_blank'><b>Installation Guide</b></a> &gt;</p>
EOF;
}
