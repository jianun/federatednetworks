 ...
 * Last Updated: $Date: 2010-07-19 11:06:34 -0400 (Mon, 19 Jul 2010) $
 * </pre>
 *
 * @author 		Matt Mecham
...
class IPSSetUp
{
	...
	static public function fetchXmlAppVersions( $app )
	{
		...
		try
		{
			if( !file_exists( IPSLib::getAppDir( $app ) . '/xml/versions.xml' ) )
			{
				return false;
			}
	...
	static public function fetchNextApplication( $previous='', $xmlFileSearch='', $charset='' )
	{
		...
		if ( $return )
		{
			return self::fetchXmlAppInformation( $return, $charset );
		}
	...
	static public function fetchXmlAppInformation( $app, $charset='' )
	{
		...
		try
		{
			if( file_exists( IPSLib::getAppDir( $app ) . '/xml/information.xml' ) )
			{
