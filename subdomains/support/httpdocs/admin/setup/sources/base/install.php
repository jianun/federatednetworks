 ...
 * Last Updated: $Date: 2010-05-05 09:11:48 -0400 (Wed, 05 May 2010) $
 * </pre>
 *
 * @author 		Matt Mecham
...
class IPSInstall
{
	...
	static public function createAdminAccount()
	{
		...
		$member = array(
						 ...
						 'members_auto_dst'			=> 1,
						 'members_editor_choice'	=> ipsRegistry::$settings['ips_default_editor'] ? ipsRegistry::$settings['ips_default_editor'] : 'std',
						 'allow_admin_mails'		=> 0,
						 'hide_email'				=> 1,
