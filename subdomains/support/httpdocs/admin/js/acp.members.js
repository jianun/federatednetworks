...
_temp.prototype.members = {
	...
	{
		// Allow "inline form" with normal form submission
		// See member password inline form
		if( acp.members.fields[ id ]['bypass'] )
		{
			return true;
		}
