...
ACPHelp = {
	...
	{
		window.open("http://acpdocs.invisionpower.com/showfull.php?pageKey=" + acpHelp['pageKey'] + "&domain=" + acpHelp['domain'] + "&version=" + acpHelp['version'], 'fullhelp', 'status=0,toolbar=0,location=0,scrollbars=1,width=600,height=700');
	...
	{
		var url = "http://acpdocs.invisionpower.com/retrieve.php?pageKey=" + acpHelp['pageKey'] + "&domain=" + acpHelp['domain'] + "&version=" + acpHelp['version'];
