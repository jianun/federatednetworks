 ...
 * Last Updated: $LastChangedDate: 2010-05-18 10:26:47 -0400 (Tue, 18 May 2010) $
 * </pre>
 *
 * @author 		$Author: matt $
 ...
 * Last Updated: $Date: 2010-05-18 10:26:47 -0400 (Tue, 18 May 2010) $
 * </pre>
 *
 * @author 		$Author: matt $
 * @copyright	(c) 2001 - 2009 Invision Power Services, Inc.
	...
	public function parseOnlineEntries( $rows )
	{
		...
		foreach( $rows as $row )
		{
			if( $row['current_appcomponent'] == 'calendar' )
			{
				...
				$row['_whereLinkSeo']  = ipsRegistry::getClass('output')->formatUrl( ipsRegistry::getClass('output')->buildUrl( 'app=calendar', 'public' ), IPSText::makeSeoTitle( 'Calendar' ), 'app=calendar' );
			}
